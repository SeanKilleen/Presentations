...
namespace OtherDemos
{
    ...
    [NUnit.Framework.DescriptionAttribute("VendingMachineProduct")]
    public partial class VendingMachineProductFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "VendingMachineProduct", "\tAs a hungry customer\r\n\tI want to receive a product \r\n\tSo that I can experience a" +
                    " yummy treat", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void ReceiveAProduct()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Receive a Product", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
